...
thumbnail:
  ...
  overview: |
    Round about 900 two and a half years after the launch of the first version of the website—which kind of never left the beta stadium—*www.bastiankroggel.com* shines in new splendor.
...
Back in 2015 at 24th of December when I released my own website to the public I was absolutely stoked and proud of what I was able to build after taking a web development course at [CareerFoundry Berlin](https://careerfoundry.com/) and getting my hands dirty with some code. Sure, I definitely had to work out some quirks and like with everything you do for the first time (better: tim**es**) you heavily evolve while doing it and kind of would like to start over at the moment the finishing line reaches the horizon.

Initially I was thinking to work on the website from time to time, but after adding some blog posts and more or less maintaining a few parts of the website that needed my attention in order to keep working, I never really came around to actually push the site further.  
What happened was, I kind of abandoned the site.  
...
3. What often is an important aspect to the people hosting the website is *money* and while you could potentially put up your blog on Wordpress without paying a dime, you—in that case—would be limited to a few features that in the end do not include your personal custom domain (like: www.yourname.com) or a non-limited access to the appearance of your website, which in the end forms the recognition value of your website.  
...
This site will most surely evolve over time, I already have some ideas and features I would like to implement soon and—since I already invested so much time and energy in this project I hope I will not abandon this site as fast as I did it with the previous version.
